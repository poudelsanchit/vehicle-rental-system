...
export default function HowItWorks() {
    const steps = [
        ...
        {
            icon: <Calendar className="h-8 w-8 text-gray-900" />,
    ...
    return (
        <section className="py-20 bg-white">
            <div className="max-w-6xl mx-auto px-6 text-center">
                <h2 className="text-3xl font-bold mb-16 text-gray-900">How It Works</h2>
                <div className="grid md:grid-cols-3 gap-8">
                    {steps.map((step, i) => (
                        <Card key={i} className="border border-gray-200 rounded-lg hover:border-gray-300 transition shadow-none">
                            ...
                            <CardContent className="text-gray-600 text-sm leading-relaxed">{step.description}</CardContent>
                        </Card>
                    ))}
                </div>
            </div>
